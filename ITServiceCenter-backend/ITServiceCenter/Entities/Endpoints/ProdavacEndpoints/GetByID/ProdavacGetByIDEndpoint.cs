...
{
    public class ProdavacGetByIDEndpoint : MyBaseEndpoint <ProdavacGetByIDRequest, ProdavacGetByIDResponse>
    {
        ...
        public override async Task <ProdavacGetByIDResponse> Obradi ([FromQuery] ProdavacGetByIDRequest request, CancellationToken cancellationToken)
        {
