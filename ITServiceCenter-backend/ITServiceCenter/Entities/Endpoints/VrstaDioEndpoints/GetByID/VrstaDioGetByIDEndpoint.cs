...
{
    public class VrstaDioGetByIDEndpoint
        : MyBaseEndpoint<VrstaDioGetByRequest, VrstaDioGetByResponse>
    {
        ...
        public override Task<VrstaDioGetByResponse> Obradi(
            [FromQuery] VrstaDioGetByRequest request,
            CancellationToken cancellationToken
        )
        {
            var data = _applicationDbContext
                .VrstaDio.OrderBy(v => v.ID)
                .Select(v => new VrstaDioGetByResponse { ID = v.ID, Naziv = v.Naziv, })
