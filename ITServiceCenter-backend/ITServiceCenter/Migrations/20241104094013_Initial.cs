    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ajdin@ajdin.com", "Ajdin", false, true, false, false, false, "0ntawirgL+1r21A07f2Llzukwvw=", "tD5kSpamM1f+SupMFpHVbg==", "Kuduzović", null, null, "ajdin" },
                    { 2, "jasir@jasir.com", "Jasir", false, false, false, true, false, "/HGnZe4dofzhQiLdKwosfxHMzvk=", "06IdVgqvtwW3nWViaKPIvw==", "Burić", null, null, "jasir" },
                    { 3, "adis@adis.com", "Adis", false, false, false, true, false, "gQfILJwSHsqmerY0JUk5cMEbDUg=", "rSBdWNayGzU3locAY9RliQ==", "Mešić", null, null, "adis" },
                    { 4, "alina@alina.com", "Alina", false, false, true, false, false, "6/9R427FIfdTo0518hnkydv2fYo=", "S88ssq8iot4BvUANfG5hSg==", "Burić", null, null, "alina" },
                    { 5, "vedad@vedad.com", "Vedad", false, false, true, false, false, "YhCXud8SmqAWW3FPuS56AxdBBDg=", "cqpX9nT7ifvWIAlcZJqtDw==", "Keskin", null, null, "vedad" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 210f, new DateTime(2024, 11, 4, 10, 40, 12, 585, DateTimeKind.Local).AddTicks(3556), "30 Dana", "", "sifraracuna1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 11, 6, 10, 40, 12, 585, DateTimeKind.Local).AddTicks(4884), new DateTime(2024, 11, 4, 10, 40, 12, 585, DateTimeKind.Local).AddTicks(4879), "Ocistiti prednju kameru", "Zamjena LCDa", "sifraservisa1" },
                    { 2, new DateTime(2024, 11, 6, 10, 40, 12, 585, DateTimeKind.Local).AddTicks(4895), new DateTime(2024, 11, 4, 10, 40, 12, 585, DateTimeKind.Local).AddTicks(4894), "", "zakljucan google acc", "sifraservisa2" },
                    { 3, new DateTime(2024, 11, 6, 10, 40, 12, 585, DateTimeKind.Local).AddTicks(4899), new DateTime(2024, 11, 4, 10, 40, 12, 585, DateTimeKind.Local).AddTicks(4897), "bitini podatci", "Spor", "sifraservisa3" },
                    { 4, new DateTime(2024, 11, 6, 10, 40, 12, 585, DateTimeKind.Local).AddTicks(4903), new DateTime(2024, 11, 4, 10, 40, 12, 585, DateTimeKind.Local).AddTicks(4902), "", "Nema slike", "sifraservisa4" },
                    { 5, new DateTime(2024, 11, 6, 10, 40, 12, 585, DateTimeKind.Local).AddTicks(4907), new DateTime(2024, 11, 4, 10, 40, 12, 585, DateTimeKind.Local).AddTicks(4905), "", "Ne radi brzo punjenje!", "sifraservisa5" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new DateTime(2024, 11, 4, 10, 40, 12, 585, DateTimeKind.Local).AddTicks(4121), 2, 1, 3 },
                    { new DateTime(2024, 11, 4, 10, 40, 12, 585, DateTimeKind.Local).AddTicks(4129), 2, 2, 3 },
                    { new DateTime(2024, 11, 4, 10, 40, 12, 585, DateTimeKind.Local).AddTicks(4132), 2, 3, 2 },
                    { new DateTime(2024, 11, 4, 10, 40, 12, 585, DateTimeKind.Local).AddTicks(4134), 2, 4, 1 }
                });
