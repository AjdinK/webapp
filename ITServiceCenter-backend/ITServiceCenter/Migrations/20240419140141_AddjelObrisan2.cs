...
{
    public partial class AddjelObrisan2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "ID", "Email", "Ime", "Is2FActive", "IsAdmin", "IsProdavac", "IsServiser", "JelObrisan", "Passweord", "Prezime", "Username" },
                values: new object[] { 1, "test@test.com", "Ajdin", false, true, false, false, false, "ajdin", "Kuduzović", "ajdin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 6, "test@test.com", "test", false, true, true, true, false, "test", "test", "test" },
                    { 4, "test@test.com", "Alina", false, false, true, false, false, "alina", "Burić", "alina" },
                    { 5, "test@test.com", "Vedad", false, false, true, false, false, "vedad", "Keskin", "vedad" },
                    { 2, "test@test.com", "Jasir", false, false, false, true, false, "jasir", "Burić", "jasir" },
                    { 3, "test@test.com", "Adis", false, false, false, true, false, "adis", "Mešić", "adis" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 210f, new DateTime(2024, 4, 19, 15, 1, 40, 855, DateTimeKind.Local).AddTicks(2964), "30 Dana", "", "sifraracuna1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 4, 21, 15, 1, 40, 855, DateTimeKind.Local).AddTicks(3266), new DateTime(2024, 4, 19, 15, 1, 40, 855, DateTimeKind.Local).AddTicks(3266), "Ocistiti prednju kameru", "Zamjena LCDa", "sifraservisa1" },
                    { 2, new DateTime(2024, 4, 21, 15, 1, 40, 855, DateTimeKind.Local).AddTicks(3270), new DateTime(2024, 4, 19, 15, 1, 40, 855, DateTimeKind.Local).AddTicks(3270), "", "zakljucan google acc", "sifraservisa2" },
                    { 3, new DateTime(2024, 4, 21, 15, 1, 40, 855, DateTimeKind.Local).AddTicks(3271), new DateTime(2024, 4, 19, 15, 1, 40, 855, DateTimeKind.Local).AddTicks(3271), "bitini podatci", "Spor", "sifraservisa3" },
                    { 4, new DateTime(2024, 4, 21, 15, 1, 40, 855, DateTimeKind.Local).AddTicks(3272), new DateTime(2024, 4, 19, 15, 1, 40, 855, DateTimeKind.Local).AddTicks(3272), "", "Nema slike", "sifraservisa4" },
                    { 5, new DateTime(2024, 4, 21, 15, 1, 40, 855, DateTimeKind.Local).AddTicks(3273), new DateTime(2024, 4, 19, 15, 1, 40, 855, DateTimeKind.Local).AddTicks(3273), "", "Ne radi brzo punjenje!", "sifraservisa5" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new DateTime(2024, 4, 19, 15, 1, 40, 855, DateTimeKind.Local).AddTicks(3109), 2, 1, 3 },
                    { new DateTime(2024, 4, 19, 15, 1, 40, 855, DateTimeKind.Local).AddTicks(3110), 2, 2, 3 },
                    { new DateTime(2024, 4, 19, 15, 1, 40, 855, DateTimeKind.Local).AddTicks(3110), 2, 3, 2 },
                    { new DateTime(2024, 4, 19, 15, 1, 40, 855, DateTimeKind.Local).AddTicks(3111), 2, 4, 1 }
                });
